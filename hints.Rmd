...
tidy(model03, conf.int = TRUE, exponentiate = TRUE, ddf = 49) %>% 
  kable() %>% 
  kable_styling()
# NOTE: At the time of writing, the function tidy() in version 0.5.6 of the 
#   {broom) package did not support adjusting degrees of freedom. The issue has 
#   been fixed and the above code will give correct results with the subsequent 
#   release. 
```
